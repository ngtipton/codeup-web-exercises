...
function isTwo(numberToTest) {
    (numberToTest == 2) ? console.log("Number was two") : console.log("Number was not two");
    return
}
...
var percentage = prompt("Tip %?");
var bill = prompt ('Bill cost?');
